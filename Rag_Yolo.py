...
vehicle_model = load_model(r"E:\Unisys2\Vehicle\best.pt")
modal_model = load_model(r"E:\Unisys2\Modal\blue\best.pt")
number_plate_model = load_model(r"E:\Unisys2\Number plate\best.pt")
...
def save_to_mongodb(track_id,data,camera_number):
    ...
    try:
        ...
        #print(f"Data for track_id {track_id} successfully saved with embedding.")

    except Exception as e:
        print(f"Database error: {e}")


def process_video_with_yolo(video_file,camera_number):
    ...
    while cap.isOpened():
        ...
        for track in tracked_objects:
            ...
            if validate_roi(vehicle_roi):
                ...
                # Modal detection
                try:
                    modal_results = modal_model.predict(vehicle_roi, conf=0.2, verbose=False, device=device)
                ...
                # Save to MongoDB
                save_to_mongodb(track_id, db_data, camera_number)
...
# Process video
    return vehicle_info
# video_file = r"E:\Unisys2\DEMO\1.mp4"  # Replace with your video file path
# camera_number = 1  # Replace with your camera number
# vehicle_info = process_video_with_yolo(video_file, camera_number)